...
This script based automation allows you to build a ready-to-use Kasten K10 demo environment running on OpenShift Container Platform on IBM Cloud in about 40 minutes. To demonsrate OpenShift Container Storage feature, the OCP cluster will have 4 worker nodes and be built in a new vpc using the new subnet, gateway. This is bash shell based scripts which has been tested on Cloud Shell. 
